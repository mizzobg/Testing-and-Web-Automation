...
//			driver = new FirefoxDriver();
		...
		public void runShoppingTest	() throws Exception  {
			...
			newSearch.enterSearch(constants.searchWord); 										// Inputing for user creation using the function and passing it the values for user and pass
			...
			if (verify.vItem().equals(constants.expectedWord)) {				// Check function for the report
			...
			assertEquals("Check if correct dress",constants.expectedWord, verify.vItem());// Runs the test check to using function and comparing the text
